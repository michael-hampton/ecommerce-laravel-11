...
Route::get('/help-topic/{slug}', [HomeController::class, 'helpTopic'])->name('help-topic');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/order/approve/{orderId}', [App\Http\Controllers\Front\UserAccountController::class, 'approveOrder'])->name('orders.approveOrder');
    Route::post('/order/report/{orderItemId}', [App\Http\Controllers\Front\UserAccountController::class, 'reportOrder'])->name('orders.reportOrder');
