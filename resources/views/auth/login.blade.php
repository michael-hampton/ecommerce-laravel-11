  ...
  <section class="h-100 h-custom gradient-custom-2">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="card card-registration card-registration-2" style="border-radius: 15px;">
        ...
        <div class="row g-0">
          @if($errors->any())
      <div class="alert alert-danger alert-dismissable px-3">{{$errors->first()}}</div>
    @endif
          <div class="col-lg-6">
          <div class="p-5">
            <h3 class="fw-normal mb-5" style="color: #4835d4;">Login</h3>
            <form method="POST" action="{{route('login.authenticate')}}" name="login-form"
        ...
        @enderror
          ...
          <div class="p-5">
            ...
            <div class="form-floating mb-3">
              <input class="form-control form-control_gray  @error('name') is-invalid @enderror" name="name"
        ...
        @enderror
            ...
            <div class="form-floating mb-3">
              ...
              class="form-control form-control_gray  @error('mobile') is-invalid @enderror" name="mobile"
