...
@section('content')
    <main class="content-wrapper">
        ...
        <section class="pb-5 mb-1 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5 container">
            <nav aria-label="breadcrumb" class="position-relative z-2 pt-3 my-3 my-md-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/help">Help center</a></li>
                    <li class="breadcrumb-item"><a href="#">Returns &amp; refunds</a></li>
                    <li class="breadcrumb-item active" aria-current="page">What is your returns policy?</li>
                </ol>
            </nav>
            <div class="row">
                <aside class="order-lg-2 pb-3 mb-3 mb-md-4 col-lg-4" style="margin-top: -115px;">
                    <div class="sticky-md-top ps-lg-4 ms-xl-3" style="padding-top: 115px;">
                        <h4 class="h5 mb-4 d-none d-lg-block">Articles in this section</h4>
                        <div class="position-relative py-1 py-sm-2 px-3 px-sm-4 p-lg-0"><span
                                class="position-absolute top-0 start-0 w-100 h-100 border rounded-4 d-lg-none"></span><button
                                type="button" aria-controls="help-articles-sidebar" aria-expanded="false"
                                class="position-relative z-1 w-100 justify-content-start border-0 px-0 d-lg-none btn btn-outline-secondary btn-lg"><i
                                    class="ci-menu fs-lg me-2"></i>Articles in this section<i
                                    class="ci-chevron-down fs-lg ms-auto"></i></button>
                            <div id="help-articles-sidebar" class="position-relative z-1 d-lg-block collapse">
                                <ul class="flex-column gap-3 pt-2 pb-3 pt-lg-0 nav">
                                    <li class="nav-item"><a data-rr-ui-event-key="#"
                                            class="hover-effect-underline fw-normal p-0 nav-link" href="#">What is your
                                            returns policy?</a></li>
                                    <li class="nav-item"><a data-rr-ui-event-key="#"
                                            class="hover-effect-underline fw-normal p-0 nav-link" href="#">I paid with
                                            Afterpay, how do returns work?</a></li>
                                    <li class="nav-item"><a data-rr-ui-event-key="#"
                                            class="hover-effect-underline fw-normal p-0 nav-link" href="#">What happens to
                                            my refund if I return 45 days?</a></li>
                                    <li class="nav-item"><a data-rr-ui-event-key="#"
                                            class="hover-effect-underline fw-normal p-0 nav-link" href="#">How do I return
                                            something to you?</a></li>
                                    <li class="nav-item"><a data-rr-ui-event-key="#"
                                            class="hover-effect-underline fw-normal p-0 nav-link" href="#">Can I return an
                                            exchange instead of a refund?</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-lg-1 col-lg-8">
                    ...
                    <p class="h6"><span class="text-body-secondary">Last Updated:</span> June 26, 2025</p>
                    ...
                    <ul>
                        ...
                        <li>Put the new product in its original packaging without any signs of use. If the product consists
                            of several parts, you must return the entire set. Make sure that nothing is lost and that you
                            return the product in the complete set in which you received it.</li>
                        <li>If you purchased a product with a gift, you must return the entire set (product and gift).
                            Otherwise, the nominal value of the gift will be deducted from the refund amount.</li>
                    ...
                    <ul class="pb-3 pb-sm-4">
                        ...
                        <li>Returns acceptance points at Cartzilla pick-up points. Here, our employee will conduct a visual
                            ...
                            within 14 days.</li>
                    </ul><img alt="Image" loading="lazy" width="1000" height="750" decoding="async" data-nimg="1"
                        class="d-block bg-body-tertiary rounded-5 mb-3"
                        srcset="/_next/image?url=%2Fimg%2Fhelp%2Fsingle.jpg&amp;w=1080&amp;q=75 1x, /_next/image?url=%2Fimg%2Fhelp%2Fsingle.jpg&amp;w=2048&amp;q=75 2x"
                        src="/_next/image?url=%2Fimg%2Fhelp%2Fsingle.jpg&amp;w=2048&amp;q=75" style="color: transparent;">
                    <h3 class="h4 pt-3 pt-sm-4">3. How will I get a refund for the goods?</h3>
                    <p>You can provide your bank card details for a refund when making a refund in your personal account on
                        the website or in a paper return form. Please indicate the card number and full name of the bank
                        card holder in English on the return form.</p>
                    <p>Usually, the money is refunded in 3-5 days after the decision to refund is made.</p>
                    <div class="py-2 py-sm-3 mt-n3">
                        <hr>
                    </div>
                    <h4 class="h5 mb-4">Was this information helpful?</h4>
                    <div class="d-flex gap-3 pb-3 mb-4"><button type="button" class="btn btn-outline-secondary"><i
                                class="ci-thumbs-up fs-base me-1 ms-n1"></i>Yes</button><button type="button"
                            class="btn btn-outline-secondary"><i class="ci-thumbs-down fs-base me-1 ms-n1"></i>No</button>
                    </div>
                    <div class="border rounded-4 p-4">
                        <div class="d-sm-flex align-items-center justify-content-between text-center text-sm-start p-md-3">
                            ...
                            </div><a class="btn btn-lg btn-primary" href="#">Contact us</a>
                        </div>
                    </div>
                </div>
            </div>
