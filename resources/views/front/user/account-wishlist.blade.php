                    ...
                    <div class="d-flex align-items-center justify-content-between pb-3 mb-1 mb-sm-2 mb-md-3">
                        ...
                        <div class="nav">
                            <a class="nav-link animate-underline px-0 py-1 py-ms-2" href="#wishlistModal"
                                ...
                                <i class="fa fa-plus fs-base me-1"></i>
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-sm-7 col-md-8 col-xxl-9 d-flex align-items-center mb-3 mb-sm-0">
                                ...
                                <div class="dropdown ms-auto ms-sm-0">
                                    <button type="button" class="btn btn-icon btn-ghost btn-secondary border-0"
                                        ...
                                        <i class="fa fa-more-vertical fs-xl"></i>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <div class="d-flex flex-column gap-1 mb-2">
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" id="wishlist-1" name="wishlist"
                                                    checked="">
                            ...
                            <div class="col-sm-5 col-md-4 col-xxl-3">
                                <div class="choices" data-type="select-one" tabindex="0" role="listbox" aria-haspopup="true"
                                    aria-expanded="false">
                                    <select class="form-select choices__input">
                                        <option value="date" selected="">By date added</option>
                                ...
                                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                                    <div class="position-relative">
                                        ...
                                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                                            href="{{route('shop.product.details', ['slug' => $item->model->slug])}}">
                                            <span
                                    ...
                                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                                        @if($item->model->reviews()->avg('rating') > 0)
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <div class="d-flex gap-1 fs-xs">
                                                    @for ($x = 0; $x < $item->model->reviews()->avg('rating'); $x++)
                                                        <i class="fa fa-star text-warning"></i>
                                                    @endfor
                                                </div>
                                                <span class="text-body-tertiary fs-xs">({{$item->model->reviews()->count()}})</span>
                                            </div>
                                        @endif
                                        <h3 class="pb-1 mb-2">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            @if($item->model->sale_price)
                                                <div class="h5 lh-1 mb-0"> {{$currency}}{{$item->model->sale_price}} <del
                                                        class="text-body-tertiary fs-sm fw-normal">{{$currency}}{{$item->model->regular_price}}</del>
                                                </div>
                                            @else
                                                <div class="h5 lh-1 mb-0"> {{$currency}}{{$item->model->regular_price}}</div>
                                            @endif

                                            @if(config('shop.show_commission'))
                                                <br
                                                    class="small commission-text">{{ App\Helper::calculateCommission(!empty($item->model->sale_price) ? $item->model->sale_price : $item->model->regular_price, true)}}
                                                inc
                                            @endif
                                            ...
                                            <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                                                ...
                                                <button type="button"
                                                    class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2 add-to-cart"
                                                    aria-label="Add to Cart">
                                                    <i class="fa fa-shopping-cart fs-base animate-target"></i>
                                                </button>
                                                {{-- <button
                                                    class="btn btn-dark btn-add-cart product-type-simple btn-shop add-to-cart">Add
                                                    to Cart</button> --}}
                                            </form>
