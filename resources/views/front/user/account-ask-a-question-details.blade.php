                                ...
                                <div class="mb-4">
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                                    <textarea name="message" class="form-control comment-input" rows="3"
                                                              placeholder="Write a comment..."></textarea>
                                            <div class="mt-4 text-end">
                                                <button type="submit" class="btn btn-comment text-white">Post
                                                    Reply
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <span
                                                    class="comment-time">{{$post->created_at->diffForHumans()}}</span>
                                            </div>
