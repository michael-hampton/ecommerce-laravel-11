                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="d-flex justify-content-between">
                            <img src="{{asset('images/products/thumbnails')}}/{{$product->image}}"
                                 alt="{{$product->name}}"
                                ...
                                <ul class="nav nav-pills nav-justified mb-3" id="myTab" role="tablist">
                                    <li class="nav-item d-flex" role="presentation">
                                        <a class="nav-link d-flex align-items-center justify-content-center w-100 active"
                                           id="tab-description-tab" data-bs-toggle="tab"
                                           href="#tab-description" role="tab" aria-controls="tab-description"
                                           aria-selected="true">Description</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link d-flex align-items-center justify-content-center w-100"
                                           id="tab-additional-info-tab" data-bs-toggle="tab"
                                           href="#tab-additional-info" role="tab" aria-controls="tab-additional-info"
                                           aria-selected="false">Additional Information</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link d-flex align-items-center justify-content-center w-100"
                                           id="tab-reviews-tab" data-bs-toggle="tab"
                                           href="#tab-reviews"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div
                                                                        ...
                                                                        style="width: 40px">
                                                                        <img
                                                                            src="{{asset('images/users/thumbnails')}}/{{$review->customer->image}}"
                                                                            alt="Avatar">
                                                                    </div>
                                                                    <div class="ps-2 ms-1">
                                                                        <div
                                                                            class="fs-sm fw-semibold text-dark-emphasis mb-1">{{$review->customer->name}}</div>
                                                                        <div
                                                                            class="fs-xs text-body-secondary">{{$review->created_at->diffForHumans()}}</div>
                                                                    </div>
                                                                </div>
