...
<div class="container mt-5">
    <div class="row g4">
        <h2>{{$title}}</h2>
        <div class="products-grid row row-cols-2 row-cols-md-3 ps-3 pe-3" id="products-grid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="pc__category">Category: {{$product->category->name}}</p>
                                <p class="pc__category">Brand: {{$product->brand->name}}</p>
