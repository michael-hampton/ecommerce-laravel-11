                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 order-2">
                                <h4 class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="badge rounded-pill bg-secondary">{{Cart::instance('cart')->count()}}</span>
                                </h4>
                                        ...
                                        @if(Session::has('discounts'))
                                            <ul class="list-unstyled">
                                                <li class="d-flex align-items-center justify-content-between">
                                                    <span>Subtotal</span>
                                                    <span class="text-end">{{$currency}}{{Cart::instance('cart')->subtotal()}}</span>
                                                </li>
                                                @if(Session::has('coupon'))
                                                    <li class="d-flex align-items-center justify-content-between">
                                                        <span>Discount {{Session::get('coupon')['code']}}</span>
                                                        <span class="text-end">{{$currency}}{{Session::get('discounts')['discount']}}</span>
                                                    </li>
                                                @endif
                                                <li class="d-flex align-items-center justify-content-between">
                                                    <span>Subtotal after discount</span>
                                                    <span class="text-end">{{$currency}}{{Session::get('discounts')['subtotal']}}</span>
                                                </li>
                                                <li class="d-flex align-items-center justify-content-between">
                                                    <span>Shipping</span>
                                                    <span class="text-end">{{$currency}}{{Session::get('discounts')['shipping']}}</span>
                                                </li>
                                                <li class="d-flex align-items-center justify-content-between">
                                                    <span>VAT</span>
                                                    <span class="text-end">{{$currency}}{{Session::get('discounts')['tax']}}</span>
                                                </li>
                                                <li class="d-flex align-items-center justify-content-between">
                                                    <span>Total</span>
                                                    <span class="text-end">{{$currency}}{{Session::get('discounts')['total']}}</span>
                                                </li>
                                            </ul>
                                        @else
                                            <ul class="list-unstyled">
