                ...
                <div class="center">
                    ...
                    <div class="center-item">
                        <ul class="menu-list">
                            ...
                            <li class="menu-item">
                                <a href="{{route('admin.askQuestion')}}" class="">
                                    <div class="icon"><i class="icon-image"></i></div>
                                    <div class="text">Ask a Question</div>
                                </a>
                            </li>
                            <li class="menu-item">
            ...
            <div class="section-content-right">
                            ...
                            <form class="form-search flex-grow">
                                <fieldset class="name">
                                    <input type="text" placeholder="Search here..." class="show-search" name="name"
                                           tabindex="2" value="" aria-required="true" required="" autocomplete="off" id="search-keyword">
                                </fieldset>
                ...
                <div class="main-content">
                    ...
                    <div class="bottom-page">
                        <div class="body-text">Copyright © 2024 Shop Pinoy</div>
                    </div>
                </div>
