...
@section('content')
    <main>
                    ...
                    <div class="overflow-hidden position-relative h-100">
                        ...
                        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                            <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                                New Arrivals</h6>
                            <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Night
                                Spring</h2>
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <!-- Hot Deals -->
            @if($products->count() > 0)
                @include('partials/product-row', ['products' => $products, 'title' => 'Hot Deals'])
            @endif
            ...
            @if($featuredProducts->count() > 0)
                @include('partials/product-row', ['products' => $featuredProducts, 'title' => 'Featured Products'])
            @endif
        </div>
