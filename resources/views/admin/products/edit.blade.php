                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input class="form-control" type="text" placeholder="Enter product name" name="name" tabindex="0"
                            ...
                            <div class="col-12">
                                ...
                                <input class="form-control" type="text" placeholder="Enter product slug" name="slug" tabindex="0"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="category_id" id="category_id">
                                    ...
                                    @foreach ($categories as $category)
                                        <option
                                            value="{{$category->id}}" @if($product->category_id === $category->id || $product->category->parent->id === $category->id) selected="selected" @endif>{{$category->name}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-control" id="subcategoryDropdown" name="subcategory_id">
                                    @if($subcategories)
                                        @foreach ($subcategories as $subcategory)
                                            <option
                                                value="{{$subcategory->id}}" @if($product->category_id == $subcategory->id) selected="selected" @endif>{{$subcategory->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0">Are you sure you want to make this item featured? Making the item featured is a great way to boost your sales on this product. It will feature on the home page and will have a higher ranking in search results</p>
            ...
            $('#featured').on('change', function () {
                if($(this).val() === '1') {
                    ...
                    var percentage = {{config('shop.featured_product_charge')}}
                        var total = ((percentage/ 100) * $('[name="regular_price"]').val()).toFixed(2);
